            ...
            <div class="row">
                @foreach ($savedJobs as $savedJob)
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="job-card">
                            <div class="favorite-icon" data-id="{{ $savedJob->job->id }}" onclick="toggleFavorite({{ $savedJob->job->id }}, this)">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p style="margin-left: 10px" class="text-muted mb-2">{{ $savedJob->job->company->name }}</p>
                                    <div style="margin-left: 10px" class="text-muted mb-3">
                                        <i class="fas fa-map-marker-alt me-2"></i>{{ $savedJob->job->location->address }}
